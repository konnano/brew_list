...
![brew_1-ezgif com-video-to-gif-converter](https://github.com/user-attachments/assets/2101df11-ce76-4334-b803-a354c2eecf85)
...
標準は辞書順表示です、引数が .(dot) なら数字順表示になります

-is : オプション  
Formulaをサイズ順で表示します  
引数が無ければインストールされてる全てのFormulaを表示します  
引数でFormulaを指定すると、そのFormulaに依存されてるFormulaのみを表示します  
引数が .(dot) ならインストールの日付順で表示します
...
-new : オプション  
キャッシュを更新します、他のオプションを起動すればバックグランドで１時間毎に更新されます  
通常は意識する必要はありません、最新で起動する場合や不具合が出た場合に使用して下さい
___  
Only Mac : Cask  
